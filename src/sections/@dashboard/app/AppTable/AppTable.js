...
const TABLE_HEAD = [
    ...
    { id: 'extensions', label: '# of extensions', alignRight: false },
    { id: '' },
];
                ...
                <Table>
                    ...
                    <TableBody>
                        {filteredItems.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                            const { id, name, contact, icon, createdAt, extensions } = row;
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell align="center">{extensions.length}</TableCell>
